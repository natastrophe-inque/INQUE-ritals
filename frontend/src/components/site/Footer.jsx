        ...
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-10">
          ...
          <div className="flex flex-col items-center gap-4">
            <a
              ...
              className="font-mono text-[11px] uppercase tracking-[0.34em] text-[#9E9E98] hover:text-[#5E8B7E] transition-colors duration-500"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.34em] text-[#9E9E98] hover:text-[#5E8B7E] transition-colors duration-500"
            >
